package com.lsk.market_analysis;

import com.lsk.market_analysis.beans.AdClickEvent;
import com.lsk.market_analysis.beans.AdCountViewByProvince;
import com.lsk.market_analysis.beans.BlackListUserWarning;
import java.net.URL;
...
public class AdStatisticsByProvince {
    ...
    public static class AdCountResult implements WindowFunction<Long, AdCountViewByProvince, String, TimeWindow> {
        @Override
        public void apply(String province, TimeWindow window, Iterable<Long> input,
