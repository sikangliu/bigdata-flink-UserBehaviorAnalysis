package com.lsk.orderpay_detect;

import com.lsk.orderpay_detect.beans.OrderEvent;
import com.lsk.orderpay_detect.beans.ReceiptEvent;
import java.net.URL;
...
public class TxPayMatch {
    ...
    public static class TxPayMatchDetect
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            receiptState =
                    getRuntimeContext().getState(new ValueStateDescriptor<ReceiptEvent>("receipt", ReceiptEvent.class));
        }
        ...
        @Override
        public void processElement2(ReceiptEvent receipt, Context ctx, Collector<Tuple2<OrderEvent, ReceiptEvent>> out)
                throws Exception {
